package com.example.streamchatdemo3.ui.login
...
import com.example.streamchatdemo3.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    private fun authenticateTheUser() {
        ...
        if (validateInput(firstName, binding.firstNameInputLayout) && validateInput(
                username,
